...
const App = () => {
  ...
  // Fetch the latest state from the backend on initial load.
  ...
  // Multi-tab localStorage sync and focus-based refresh are no longer needed
  // because state is read directly from the backend on every action.
  //
  // useEffect(() => {
